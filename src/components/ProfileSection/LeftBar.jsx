...
const LeftBar = ({Profile,SignOut, DeleteAcc, SetProfile }) => {
  return (
    <div className=" h-screen w-72   font-serif bg-primary hidden  sm:block z-100 ">
          ...
          <div className="flex flex-col gap-4 mt-5">
            <h1
              className={`font-semibold ${
                Profile ? "bg-secondary scale-105" : ""
              } uppercase text-[#FFF7ED] text-xl cursor-pointer hover:bg-secondary hover:scale-105  p-3 pl-5`}
              onClick={() => SetProfile(true)}
            >
              Profile
            </h1>
            <h1
              className={`font-semibold ${Profile?"":"bg-secondary scale-105"} uppercase text-[#FFF7ED] text-xl cursor-pointer hover:bg-secondary hover:scale-105 p-3 pl-5`}
